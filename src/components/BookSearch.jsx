  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-4">
        ...
        <Link to="/my-bookshelf" className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-full">
          My Bookshelf
        </Link>
      </div>
      {query.length === 0 ? (
        <div className="text-center text-3xl mt-10 mr-24">Search for your books</div>
      ) : (
